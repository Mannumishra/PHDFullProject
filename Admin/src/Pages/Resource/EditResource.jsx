...
const EditResource = () => {
    ...
    useEffect(() => {
        const fetchResource = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/single-resources/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:8000/api/update-resources/${id}`, formData, {
                headers: {
                ...
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    {existingPdf && (
                        <div className="col-md-12">
                            <p>Current Resource PDF: <a href={`http://localhost:8000/${existingPdf}`} target="_blank" rel="noopener noreferrer">{existingPdf}</a></p>
                        </div>
                    )}
