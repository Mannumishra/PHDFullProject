...
const EditDisciplinesCourse = () => {
    ...
    useEffect(() => {
        const fetchDisciplines = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/all-discipline'); // Adjust endpoint
    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/single-disciplines-course/${id}`);
                setFormData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:8000/api/update-disciplines-course/${id}`, formData); // Adjust endpoint
