...
const AddDisciplinesCourse = () => {
    ...
    useEffect(() => {
        const fetchDisciplines = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/all-discipline'); // Adjust endpoint as needed
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/add-disciplines-course', formData); // Adjust endpoint as needed
