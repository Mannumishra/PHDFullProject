...
const EditUniversity = () => {
    ...
    useEffect(() => {
        ...
        const fetchUniversity = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/single-universities/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:8000/api/update-universities/${id}`, { UniversityZone: university.UniversityZone });
