...
const AllUniversity = () => {
    ...
    useEffect(() => {
        ...
        const fetchUniversities = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/all-universities');  // Adjust the endpoint as needed
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`http://localhost:8000/api/delete-universities/${id}`);
