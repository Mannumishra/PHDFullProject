...
const EditDisciplines = () => {
    ...
    useEffect(() => {
        const fetchDiscipline = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/single-discipline/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:8000/api/update-discipline/${id}`, formData, {
                ...
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-6">
                        ...
                        {discipline.DisciplinesLogo && typeof discipline.DisciplinesLogo === 'string' ? (
                            <img
                                src={`http://localhost:8000/${discipline.DisciplinesLogo}`}
                                alt="Discipline Logo"
                                width="50"
                                height="50"
                            />
