...
const AllDisciplinesCourseDetails = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("http://localhost:8000/api/all-disciplines-course-details");
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`http://localhost:8000/api/delete-disciplines-course-details/${id}`);
