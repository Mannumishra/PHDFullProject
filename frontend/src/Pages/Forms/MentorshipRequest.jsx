        ...
        <div className="phd-forms">
          ...
          <form onSubmit={handleSubmit} className="mt-4">
            <div className="row">
              ...
              <div className="col-md-12 mb-2">
                <div className="form-group">
                  <h4 className="text-center">Availability</h4>
              ...
              <div>
                <p>
                  <b>Declaration:</b> I understand that by submitting this request, I am seeking mentorship and will respect the mentor's time and availability.
                </p>
              </div>
            </div>
          </form>
